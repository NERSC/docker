...
install -p -m 755 bundles/%{vers}/dynbinary/docker-%{vers} %{buildroot}%{_bindir}/docker

# install dockerinit
install -d %{buildroot}%{_libexecdir}/docker
install -p -m 755 bundles/%{vers}/dynbinary/dockerinit-%{vers} %{buildroot}%{_libexecdir}/docker/dockerinit
